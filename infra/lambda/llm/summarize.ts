...
ルール：
- ユーザーの発言・要望・決定事項・感情の変化を中心にまとめる
- 「何について話し、何が決まり、何が未解決か」を明確にする
- AIアシスタントの設定情報（名前・性別・年齢・キャラクター設定・性格描写）は含めない
- ユーザーの基本属性（年齢・職業・居住地等）は含めない（別途永久記憶で管理されている）
- 500文字以内で簡潔に
...
- AIアシスタントの設定情報（名前・性別・年齢・キャラクター設定）は含めない
- ユーザーの基本属性（年齢・職業・居住地等）は含めない
